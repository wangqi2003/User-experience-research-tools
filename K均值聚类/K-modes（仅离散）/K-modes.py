...
x = np.genfromtxt('D:\GitHub\Practices-code\K-modes\soybean.csv', dtype=int, delimiter=',')[:, :-1]
y = np.genfromtxt('D:\GitHub\Practices-code\K-modes\soybean.csv', dtype=str, delimiter=',', usecols=(35, ))
...
for result in (kmodes_huang, kmodes_cao):#通过huang、Cao两人的不同距离计算方法进行，得到两组结果，具体可参见论文。
